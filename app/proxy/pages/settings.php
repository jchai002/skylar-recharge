...
<div class="hidden">
	<div id="sc-cancel-modal">
		...
		<div class="sc-modal-links">
			<div class="sc-modal-linkbox" onclick="location.href='/tools/skylar/subscriptions?c=<?=$_REQUEST['c']?><?=empty($_REQUEST['alias']) ? '' : '&alias='.$_REQUEST['alias'] ?>&intent=changedate'; return false;">
			...
			<div class="sc-modal-linkbox" onclick="location.href='/tools/skylar/subscriptions?c=<?=$_REQUEST['c']?><?=empty($_REQUEST['alias']) ? '' : '&alias='.$_REQUEST['alias'] ?>&intent=swapscent'; return false;">
