...
<div class="hidden">
	<div id="sc-cancel-modal">
		...
		<div class="sc-modal-links">
			<div class="sc-modal-linkbox" onclick="location.href='/tools/skylar/subscriptions?c=<?=$_REQUEST['c']?>&intent=changedate'; return false;">
			...
			<div class="sc-modal-linkbox" onclick="location.href='/tools/skylar/subscriptions?c=<?=$_REQUEST['c']?>&intent=swapscent'; return false;">
