                                    ...
                                    <div class="portal-edit-control">
                                        <?php foreach($scent_change_options as $scent_change_option){ ?>
                                            <div class="portal-swap-option">
                                                <input type="radio" id="edit-scent-<?=$item['subscription_id']?>" class="swap-variant" name="variant" value="<?=$scent_change_option['shopify_variant_id']?>"<?= $scent_change_option['shopify_variant_id'] == $item['shopify_variant_id'] ? ' checked' : '' ?>>
