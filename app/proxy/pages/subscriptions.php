				...
				foreach($upcoming_shipments as $upcoming_shipment){
					...
					<div class="sc-upcoming-shipment">
						...
						<?php foreach($upcoming_shipment['items'] as $item){ ?>
							...
							<div class="sc-box-item" data-address-id="<?=$item['address_id']?>" data-variant-id="{{ box_product.variants.first.id }}" data-date="<?= date('Y-m-d', $upcoming_shipment['ship_date_time'])?>">
