...
<div class="sc-portal-page sc-portal-{{ portal_page }} sc-portal-container">
	...
	<div class="sc-portal-content">
		<div class="sc-portal-innercontainer">
			...
			{% if is_alias %}Aliased accounts do not currently support order history. Please view the customer's orders from <a href="/admin/customers/{{customer_id}}" target="_blank">the Shopify admin</a>.
