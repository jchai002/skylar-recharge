...
curl -g -X GET "https://"$3"@maven-and-muse.myshopify.com/admin/api/2019-10/themes/"$2"/assets.json?asset[key]=config/settings_data.json" | jq '.value' > src/config/settings_data.json
